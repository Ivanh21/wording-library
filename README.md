...
Config app.module.ts :
    ...
    TranslateModule.forRoot({
     ...
     WordingLibraryModule.forRoot({
        ...
        interval: 30 * 60 * 1000, //Exemple: 10min pour le nombre de temps que le système va rejouer la fonction initVersionCheck pour voir si des nouveaux fichiers ainsi que les traductions sont disponibles. 
...
app.component.ts
	...
	export class AppComponent implements OnInit {
  	...
  	constructor(private translate: TranslateService) {
    	...
    	const langToUse = savedLang ? savedLang : 'en';

    	translate.setDefaultLang('en');
    	translate.use(langToUse)
  	}
  	ngOnInit(): void {
    	this.lastLang = localStorage.getItem('app_lang') || "";
  	}
