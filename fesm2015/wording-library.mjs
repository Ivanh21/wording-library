...
class WordingLibraryService {
    ...
    initVersionCheck() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const serverVersions = yield lastValueFrom(this.http.get(`${this.config.baseUrl}/${this.config.fileConfigVersion}.json`));
                let hasNewVersion = false;
                ...
                for (const lang of Object.keys(serverVersions)) {
                    ...
                    if (localV !== serverV) {
                        ...
                        if (currentLang === lang) {
                            yield lastValueFrom(this.translate.reloadLang(lang));
                            //await lastValueFrom(this.translate.use(lang));
                        }
                    }
                }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.10", ngImport: i0, type: WordingLibraryService, decorators: [{
        ...
        return [{ type: i1.HttpClient }, { type: i2.TranslateService }, { type: WordingCacheService }, { type: undefined, decorators: [{
                        type: Inject,
